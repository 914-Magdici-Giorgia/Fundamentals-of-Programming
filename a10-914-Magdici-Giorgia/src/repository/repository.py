...
from src.utilities import Data
...
class Repository(object):
    ...
    def find_by_id(self, entity_id):
        ...
        """
        if entity_id in self._entities.ids():
    ...
    def get_all(self):
        ...
        """
        return list(self._entities.info())
...
class BookTextFileRepository (Repository):
    ...
    def _save_file(self):
        ...
        for book in self._entities.info():
            f.write(str(book)+'\n')
        f.close()
...
class ClientTextFileRepository (Repository):
    ...
    def _save_file(self):
        ...
        for client in self._entities.info():
            f.write(str(client)+'\n')
        f.close()
...
class RentalTextFileRepository (Repository):
    ...
    def _save_file(self):
        ...
        for rental in self._entities.info():
            f.write(str(rental)+'\n')
        f.close()
