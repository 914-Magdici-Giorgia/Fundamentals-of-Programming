...
class RentalService:
    ...
    def books_statistic(self):
        ...
        for book in books:
            ...
            rented_books.append([book.id,number_of_rentals])

        statistics=dict(sort(rented_books,key=lambda x:x[1], reverse=True))
        return statistics
    ...
    def clients_statistics(self):
        ...
        for client in clients:
            ...
            active_clients.append([client.id,client_days])

        statistics = dict(sort(active_clients, key=lambda x:x[1], reverse=True))
        #print(statistics)
    ...
    def author_statistics(self):
        ...
        list_authors=[]
        for author in rented_authors.keys():
            list_authors.append([author,rented_authors[author]])

        statistics = dict(sort(list_authors, key=lambda x:x[1], reverse=True))
        #print(statistics)
        return statistics
